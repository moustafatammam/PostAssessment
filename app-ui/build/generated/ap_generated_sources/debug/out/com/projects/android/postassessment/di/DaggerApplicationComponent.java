...
import com.projects.android.domain.useCases.impl.GetCountUseCase_Factory;
...
public final class DaggerApplicationComponent implements ApplicationComponent {
  ...
  private final class MainActivitySubcomponentImpl implements AppUiModule_ContributeMainActivity.MainActivitySubcomponent {
    ...
    private Provider<GetCountUseCase> getCountUseCaseProvider;
    ...
    private Provider<PostDetailsFragment> postDetailsFragmentProvider;

    private Provider<EditPostFragment> editPostFragmentProvider;

    private Provider<CreatePostFragment> createPostFragmentProvider;
    ...
    private Map<Class<? extends Fragment>, Provider<Fragment>> getMapOfClassOfAndProviderOfFragment(
      ...
      return MapBuilder.<Class<? extends Fragment>, Provider<Fragment>>newMapBuilder(4).put(PostListFragment.class, (Provider) postListFragmentProvider).put(PostDetailsFragment.class, (Provider) postDetailsFragmentProvider).put(EditPostFragment.class, (Provider) editPostFragmentProvider).put(CreatePostFragment.class, (Provider) createPostFragmentProvider).build();}
    ...
    private void initialize(final MainActivity arg0) {
      ...
      this.getCountUseCaseProvider = GetCountUseCase_Factory.create((Provider) DaggerApplicationComponent.this.postDataRepositoryProvider, (Provider) JobExecutor_Factory.create(), (Provider) UiThread_Factory.create());
      this.addPostViewModelProvider = AddPostViewModel_Factory.create(addPostUseCaseProvider, getCountUseCaseProvider, PresenterMapperImpl_Factory.create());
      ...
      this.postListFragmentProvider = PostListFragment_Factory.create(viewModelFactoryProvider, ViewMapperImpl_Factory.create());
      this.postDetailsFragmentProvider = PostDetailsFragment_Factory.create(viewModelFactoryProvider, ViewMapperImpl_Factory.create());
      this.editPostFragmentProvider = EditPostFragment_Factory.create(viewModelFactoryProvider, ViewMapperImpl_Factory.create());
      this.createPostFragmentProvider = CreatePostFragment_Factory.create(viewModelFactoryProvider, ViewMapperImpl_Factory.create());
    }
